...
cap = cv2.VideoCapture('Resources/UHD.mp4')
...
image = cv2.resize(frame, (1080, 1920), None, ratio, ratio)  # resize image
...
while True:
    ...
    if ret:  # if there is a frame continue with code
        ...
        lineypos = 225
        cv2.line(image, (135, lineypos), (610, lineypos), (255, 0, 0), 5)

        # line y position created to count contours
        lineypos2 = 250
        cv2.line(image, (120, lineypos2), (630, lineypos2), (0, 255, 0), 5)

        # min area for contours in case a bunch of small noise contours are created (def=300)
        minarea = 2000
        ...
        cv2.rectangle(image, (0, 0), (250, 100), (166, 88, 13), -1)  # background rectangle for on-screen text

        cv2.putText(image, "Cars in Area: " + str(currentcars), (0, 15), cv2.FONT_HERSHEY_SIMPLEX, .5, (0, 170, 0), 1)

        cv2.putText(image, "Cars Crossed Up: " + str(carscrossedup), (0, 30), cv2.FONT_HERSHEY_SIMPLEX, .5, (255, 211, 0),
                    1)
